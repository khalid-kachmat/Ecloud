<template>
  <section class="  ">
    <div class="xl:w-full flex justify-center my-4 font-semibold text-gray-500 mt-10">
      <h1><span>Service and Assurance information</span></h1>
    </div>
    <div class="flex">
