      ...
      <div><span style="color:red" v-show="errorField">{{ error }}</span>
        <div class="flex justify-center items-center w-full space-y-5 space-x-12">
          <div class="flex w-1/2 flex-col justify-center">
            <label class="leading-loose font-semibold">Service<span class="text-red-500">
        *
       </span></label>
          ...
          <div class="flex w-1/2 flex-col justify-center">
            <label class="leading-loose font-semibold">Start Date/Time<span class="text-red-500">
        *
       </span></label>
            <div class="flex full space-x-3  justify-center">
              ...
              <input
                  ...
                  class="border-gray-200 border-2 px-4 py-2  w-30 sm:text-sm focus:outline-none focus:ring-2 focus:ring-green-200 shadow-sm transition duration-200  pb-3 rounded-mdd"
                  type="time">
            </div>
        ...
        <div class="flex justify-center items-center w-full space-x-12">
          <div class="flex w-1/2 flex-col justify-center ">
            <label class="leading-loose font-semibold">Doctor<span class="text-red-500">
        *
       </span></label>
          ...
          <div class="flex w-1/2 flex-col justify-center ">
            <label class="leading-loose font-semibold">End Date/Time<span class="text-red-500">
        *
       </span></label>
            <div class="flex full space-x-3 justify-center">
              ...
              <input v-model="endTime" name="endTime"
                     class="border-gray-200 border-2 px-4 py-2  w-30 sm:text-sm focus:outline-none focus:ring-2 focus:ring-green-200 shadow-sm transition duration-200  pb-3 rounded-md"
                     type="time">
            </div>
          </div>
        </div>
      ...
      <div class=" w-full justify-center items-center  py-12">
        ...
        <div class="flex w-full justify-center item-center space-x-3">
          ...
          <button
              ...
              class=" p-1 border  border-gray-500 hover:border-white text-sm hover:text-white hover:bg-gray-500 text-gray-500 font-bold transition ease-in-out duration-700  rounded-xl inline-flex items-center">
          ...
          <button
              ...
              class=" p-1 border  border-gray-500 hover:border-white hover:text-white text-sm hover:bg-gray-500 text-gray-500 font-bold transition ease-in-out duration-700  rounded-xl inline-flex items-center">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                 xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class=" " :class="selectBtn ? 'hidden' : 'block' ">
          ...
          <div class="flex flex-wrap space-x-4 w-full justify-center rounded-xl items-center bg-green-100 border-gray-200 border-2 "
        ...
        *
            ...
            <div class="flex flex-col 1/4 justify-center">
              ...
              <input v-model="age" type="number" readonly name="age"
                     class="px-4 py-2  w-16 sm:text-sm bg-gray-100 focus:outline-none rounded-md cursor-default ">
            </div>
        ...
        *
              ...
              <input v-model="cin" type="text" placeholder="Enter Cin"
                     class="border-gray-200 border-2 px-4 py-2  w-2/3 sm:text-sm focus:outline-none focus:ring-2 focus:ring-green-200 shadow-sm transition duration-200  pb-3 rounded-md">
        ...
        *
            ...
            <select @change="importAssuranceId" name="assurance" v-model="assurance"
                    class="border-gray-200 border-2 px-4 py-2  w-2/3 sm:text-sm focus:outline-none focus:ring-2 focus:ring-green-200 shadow-sm transition duration-200  pb-3 rounded-md">
              <option disabled selected>Select Assurance</option>
